...
<body>
	...
	<?php
		...
		if ($_SESSION['lives'] == 0){
			...
			echo "<p><a href='index.php'>Restart</a></p>";
			...
			$query = "INSERT INTO scores (username, score, playtime, foto) VALUES ('".$_COOKIE['username']."', ".$_SESSION['score'].", '".date('Y-m-d H:i:s')."','".$_COOKIE['foto']."')";
